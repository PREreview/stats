.PHONY: build build-image check format lint-css lint-ts playwright-browser prod start test test-integration typecheck
...
check: format lint-css lint-ts test typecheck
